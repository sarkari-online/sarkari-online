...
PROMPT;
    ...
    private function buildHtml(array $cycle, array $kw, array $facts, string $portal, bool $isArchived): string
    {
        ...
        if ($isArchived) {
            ...
            <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-left: 4px solid #64748b; border-radius: 8px; padding: 1.15rem 1.25rem; margin-bottom: 1.75rem; display: flex; align-items: flex-start; gap: 14px;">
                <div style="font-size: 1.4rem; line-height: 1; flex-shrink: 0; padding-top: 2px;">📁</div>
                <div>
                    <div style="font-size: 0.85rem; font-weight: 800; color: #475569; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 0.25rem;">Archived Application Notice</div>
...
HTML;
            ...
            $statusBannerHtml = <<<HTML
            <div style="background: #eff6ff; border: 1px solid #bfdbfe; border-left: 4px solid #2563eb; border-radius: 8px; padding: 1.15rem 1.25rem; margin-bottom: 1.75rem; display: flex; align-items: flex-start; gap: 14px;">
                <div style="font-size: 1.4rem; line-height: 1; flex-shrink: 0; padding-top: 2px;">✏️</div>
                <div>
                    <div style="font-size: 0.85rem; font-weight: 800; color: #1e40af; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 0.25rem;">Application Correction Window Currently Active</div>
...
HTML;
            ...
            $statusBannerHtml = <<<HTML
            <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-left: 4px solid #16a34a; border-radius: 8px; padding: 1.15rem 1.25rem; margin-bottom: 1.75rem; display: flex; align-items: flex-start; gap: 14px;">
                <div style="font-size: 1.4rem; line-height: 1; flex-shrink: 0; padding-top: 2px;">🟢</div>
                <div>
                    <div style="font-size: 0.85rem; font-weight: 800; color: #166534; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 0.25rem;">Online Application Window Is Live</div>
...
HTML;
        ...
        $tableRowsHtml = "<tr style=\"border-bottom: 1px solid #f1f5f9;\"><th style=\"width: 34%; text-align: left; padding: 0.75rem 1.15rem; background: #f8fafc; color: #475569; font-weight: 600;\">Conducting Authority</th><td style=\"padding: 0.75rem 1.15rem; color: #0f172a; font-weight: 700;\">{$authCode}</td></tr>\n";
        if ($appStart !== null && $appEnd !== null) {
            $tableRowsHtml .= "                    <tr style=\"border-bottom: 1px solid #f1f5f9;\"><th style=\"padding: 0.75rem 1.15rem; background: #f8fafc; color: #475569; font-weight: 600;\">Application Window</th><td style=\"padding: 0.75rem 1.15rem; color: #0f172a; font-weight: 600;\">{$appStart} to {$appEnd}</td></tr>\n";
        } elseif ($appEnd !== null) {
            $tableRowsHtml .= "                    <tr style=\"border-bottom: 1px solid #f1f5f9;\"><th style=\"padding: 0.75rem 1.15rem; background: #f8fafc; color: #475569; font-weight: 600;\">Last Date to Apply</th><td style=\"padding: 0.75rem 1.15rem; color: #0f172a; font-weight: 600;\">{$appEnd}</td></tr>\n";
        } elseif ($appStart !== null) {
            $tableRowsHtml .= "                    <tr style=\"border-bottom: 1px solid #f1f5f9;\"><th style=\"padding: 0.75rem 1.15rem; background: #f8fafc; color: #475569; font-weight: 600;\">Application Start Date</th><td style=\"padding: 0.75rem 1.15rem; color: #0f172a; font-weight: 600;\">{$appStart}</td></tr>\n";
        }

        if ($feeGen !== null) {
            $tableRowsHtml .= "                    <tr style=\"border-bottom: 1px solid #f1f5f9;\"><th style=\"padding: 0.75rem 1.15rem; background: #f8fafc; color: #475569; font-weight: 600;\">General / OBC Application Fee</th><td style=\"padding: 0.75rem 1.15rem; color: #0f172a; font-weight: 600;\">{$feeGen}</td></tr>\n";
        }

        $tableRowsHtml .= "                    <tr><th style=\"padding: 0.75rem 1.15rem; background: #f8fafc; color: #475569; font-weight: 600;\">Official Portal</th><td style=\"padding: 0.75rem 1.15rem;\"><a href=\"{$portalUrl}\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color: #1e3a8a; font-weight: 700; text-decoration: underline;\">{$portalUrl} ↗</a></td></tr>";
...
<div class="application-guide-content">
    ...
    <section style="margin: 1.75rem 0 2rem 0;">
        <div style="overflow-x: auto; border: 1px solid #e2e8f0; border-radius: 10px; background: #ffffff;">
            <table style="width: 100%; border-collapse: collapse; font-size: 0.9rem;">
                <thead>
                    <tr style="background: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                        <th colspan="2" style="padding: 0.85rem 1.15rem; text-align: left; color: #1e3a8a; font-size: 0.95rem; font-weight: 800; letter-spacing: 0.3px;">
...
{$tableRowsHtml}
    ...
    <div style="background: #fffbeb; border: 1px solid #fef3c7; border-left: 4px solid #f59e0b; border-radius: 8px; padding: 1.15rem 1.25rem; margin-bottom: 2rem;">
        <div style="font-size: 0.82rem; font-weight: 800; color: #b45309; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 0.35rem; display: flex; align-items: center; gap: 6px;">
    ...
    <section style="margin-bottom: 2.5rem;">
        <h2 style="font-size: 1.35rem; font-weight: 800; color: #0f172a; margin: 0 0 1.25rem 0;">📋 Step-by-Step Online Application Process</h2>
        
        <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 10px; padding: 1.25rem 1.5rem; margin-bottom: 1.15rem; box-shadow: 0 1px 2px rgba(15,23,42,0.04); display: flex; gap: 1.25rem; align-items: flex-start;">
            <div style="width: 36px; height: 36px; border-radius: 50%; background: #1e3a8a; color: #ffffff; font-weight: 800; font-size: 0.95rem; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                1
            </div>
            <div style="flex: 1;">
                ...
                <p style="font-size: 0.935rem; color: #334155; line-height: 1.65; margin: 0;">
                    Sabse pehle official portal (<a href="{$portalUrl}" target="_blank" rel="noopener noreferrer" style="color: #1e3a8a; font-weight: 600; text-decoration: underline;">{$portalUrl} ↗</a>) par jayein aur "New Candidate Registration" link par click karein. Apna active mobile number aur valid email ID enter karein. System se OTP verify hone ke baad aapka Application Number / Login ID generate ho jayega.
                </p>
            </div>
        </div>
        ...
        <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 10px; padding: 1.25rem 1.5rem; margin-bottom: 1.15rem; box-shadow: 0 1px 2px rgba(15,23,42,0.04); display: flex; gap: 1.25rem; align-items: flex-start;">
            ...
            <div style="flex: 1;">
                <h3 style="font-size: 1.05rem; font-weight: 700; color: #0f172a; margin: 0 0 0.4rem 0;">
                    Candidate Details &amp; Educational Qualifications
                </h3>
                <p style="font-size: 0.935rem; color: #334155; line-height: 1.65; margin: 0;">
        ...
        <div style="background: #ffffff; border: 1px solid #bbf7d0; border-radius: 10px; padding: 1.25rem 1.5rem; margin-bottom: 1.15rem; box-shadow: 0 1px 2px rgba(15,23,42,0.04); display: flex; gap: 1.25rem; align-items: flex-start;">
            <div style="width: 36px; height: 36px; border-radius: 50%; background: #16a34a; color: #ffffff; font-weight: 800; font-size: 0.95rem; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                5
            </div>
            <div style="flex: 1;">
                <h3 style="font-size: 1.05rem; font-weight: 700; color: #166534; margin: 0 0 0.4rem 0;">
                    Final Submission &amp; Confirmation Page Download
                </h3>
                <p style="font-size: 0.935rem; color: #334155; line-height: 1.65; margin: 0;">
    ...
    <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 2rem; text-align: center; margin-top: 2rem;">
        <h3 style="font-size: 1.2rem; font-weight: 800; color: #0f172a; margin: 0 0 0.5rem 0;">
            Ready to Apply or Correct Form?
        </h3>
        <p style="font-size: 0.925rem; color: #64748b; margin: 0 0 1.25rem 0;">
            Visit the statutory {$authCode} portal directly for live submissions and notices.
        </p>
        <a href="{$portalUrl}" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 8px; background: #1e3a8a; color: #ffffff; font-weight: 700; font-size: 0.95rem; padding: 0.8rem 1.6rem; border-radius: 8px; text-decoration: none; box-shadow: 0 2px 4px rgba(30,58,138,0.25);">
