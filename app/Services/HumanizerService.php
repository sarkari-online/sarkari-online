...
class HumanizerService
{
    ...
    /**
     * Formal AI academic jargon mappings -> Plain human web phrases
     */
    private const FORMAL_JARGON_MAP = [
        // AI formal notification & announcement templates
        '/\bhas issued a formal notification for the recruitment of\b/i' => 'has announced recruitment for',
        '/\bhas issued a formal notification for\b/i'                    => 'has announced',
        '/\bhas issued a formal notification\b/i'                        => 'has released the notification',
        '/\bissued a formal notification\b/i'                            => 'released the notification',
        '/\bformal notification\b/i'                                     => 'official notification',

        // AI academic qualification templates
        '/\bcandidates must possess a bachelor\'?s degree from a recognized university alongside a valid\b/i' => "Bachelor's degree with valid",
        '/\bcandidates must possess a bachelor\'?s degree from a recognized university\b/i'                   => "Bachelor's degree from a recognized university",
        '/\bcandidates must possess a\b/i'                                                                   => 'Candidates need a',
        '/\bcandidates must possess\b/i'                                                                     => 'Candidates must have',
        '/\bpossession of an active qualifying certificate [^\.\n<]+ is mandatory\b/i'                     => 'Must have passed qualifying teacher eligibility test (such as UPTET or CTET)',
        '/\bpossession of an? (?:active )?qualifying certificate\b/i'                                        => 'valid qualifying certificate',
        '/\bis mandatory\b/i'                                                                                => 'is required',

        // AI age limit templates
        '/\bthe prescribed age limit is (\d+ to \d+ years), with category-based relaxations applicable as per (?:state|central)?\s*government service rules\b/i' => '$1. Standard relaxations apply for reserved categories',
        '/\bthe prescribed age limit is (\d+ to \d+ years)\b/i'                                              => '$1',
        '/\bcategory-based relaxations applicable as per (?:state|central)?\s*government service rules\b/i'  => 'Standard age relaxations apply for reserved categories',
        '/\bcategory-based relaxations\b/i'                                                                  => 'category relaxations',
        '/\bprescribed age limit\b/i'                                                                        => 'age limit',
        '/\bprescribed format\b/i'                                                                           => 'required format',
        '/\bprescribed\b/i'                                                                                  => 'specified',

        // AI verification & document templates
        '/\bshortlisted candidates must undergo a mandatory verification of original academic certificates and identity documents before final appointment\b/i' => 'In-person verification of original certificates and ID proof before appointment',
        '/\bmandatory verification of original academic certificates\b/i'                                    => 'verification of original certificates',
        '/\bscrutiny of original certificates\b/i'                                                           => 'original certificate verification',
        '/\bscrutiny of documents\b/i'                                                                       => 'document verification',

        // AI official site & third party templates
        '/\bthe commission does not authorize third-party websites for the dissemination of official examination schedules or result declarations\b/i' => 'Check the official website for genuine updates. Do not rely on unverified third-party circulars',
        '/\bthe commission does not authorize third-party websites for the dissemination of [^\.\n<]+\b/i'   => 'Check the official website for verified updates',
        '/\bfor the dissemination of official examination schedules or result declarations\b/i'              => 'for exam dates or results',
        '/\bfor the dissemination of\b/i'                                                                    => 'for publishing',
        '/\bdissemination of\b/i'                                                                            => 'release of',
        '/\bdissemination\b/i'                                                                               => 'distribution',

        // AI jargon terms
        '/\bcontingent upon\b/i'                                                                             => 'depends on',
        '/\bin accordance with the prescribed state educational service regulations\b/i'                     => 'as per state rules',
        '/\bin accordance with the prescribed\b/i'                                                           => 'as per the',
        '/\bin accordance with\b/i'                                                                          => 'as per',
        '/\bsolely through the designated\b/i'                                                               => 'only on the',
        '/\bdesignated online recruitment portal\b/i'                                                        => 'official website',
        '/\brequired to authenticate their credentials\b/i'                                                  => 'need to log in',
        '/\bdiscrepancies in the submitted credentials\b/i'                                                  => 'errors in application details',
        '/\bstatutory recruitment details and application instructions\b/i'                                  => 'recruitment details and application steps',
        '/\bprovisional answer keys and recorded candidate response schedules\b/i'                          => 'provisional answer key and response sheet',
        '/\bofficial scorecards and category-wise qualifying thresholds\b/i'                                 => 'official scorecards and category cutoffs',
        '/\bofficial admit cards and examination venue allocations\b/i'                                      => 'official admit card and exam venue details',
        '/\ball relevant supporting documentation\b/i'                                                       => 'all required documents',
        '/\bpertaining to\b/i'                                                                               => 'about',
        '/\bfurnish\b/i'                                                                                     => 'provide',
        '/\bfurnished\b/i'                                                                                   => 'provided',
        '/\bcommencement of\b/i'                                                                             => 'start of',
        '/\bprior to the commencement\b/i'                                                                   => 'before the start',
        '/\bstatutory\b/i'                                                                                   => 'official',
        '/\bstipulated\b/i'                                                                                  => 'specified',
        '/\baforementioned\b/i'                                                                              => 'mentioned',
        '/\balongside a valid\b/i'                                                                           => 'with valid',
        '/\balongside\b/i'                                                                                   => 'with',
        '/\bscrutiny\b/i'                                                                                    => 'verification',
    ];

    /**
     * Programmatically de-formalize academic gazette jargon into simple human phrasing.
     */
    public static function dewriteFormalJargon(string $text): string
    {
        return (string)preg_replace(array_keys(self::FORMAL_JARGON_MAP), array_values(self::FORMAL_JARGON_MAP), $text);
    }
